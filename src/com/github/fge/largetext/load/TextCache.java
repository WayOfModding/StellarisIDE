 ...
 *
 * <p>
 * This class will load character sequences from a large text file as described
 * by {@link TextRange} instances (which are produced by a {@link
 * TextDecoder} instance).</p>
 *
 * <p>
 * This uses Guava's {@link LoadingCache} to do the job. The default expiry
...
public final class TextCache {
     ...
     *
     * <p>
     * Note that it calls {@link LoadingCache#getUnchecked(Object)}; therefore
     * all loading failures will throw an <em>unchecked</em>
     * exception.</p>
     *
     ...
     *
     * <p>
     * The map entries will be ordered the same way as ranges appear in the
    ...
    private CacheLoader<TextRange, CharBuffer> loader() {
        return new CacheLoader<TextRange, CharBuffer>() {
            @Override
            public CharBuffer load(final TextRange key)
                    throws IOException {
